...
#let left-content = [
  ...
  #left-section(title: "Technical skills", [
    ...
    - *Frameworks*: Swing, Sping, Express.js, Node.js
...
#show: cv.with(
  title: name,
  subtitle: [
    Software Engineering Student - Java / Spring / Web Development\
    *Available from March 2026 for a 6-month internship (Paris or remote)*\
  ],
...
#cv-entry(
  ...
  [
    - Designed a full-stack file-storage app using Express.js, Typescript and Node.js
    - Implemented a REST API for file operations
    - Focus on modularity adn maintainability
  ],
)
