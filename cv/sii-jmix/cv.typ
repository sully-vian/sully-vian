...
#let left-content = [
  ...
  #left-section(title: "Hard Skills", [
    ...
    - *Frameworks*: Spring Boot, JPA, JUnit, Locust
...
#show: cv.with(
  title: name,
  subtitle: [
    Étudiant en Génie Logiciel à l'ENSEEIHT - Recherche un stage backend/full-stack java\
...
#cv-entry(
  ...
  [
    ...
    - Documentation détaillée de l'API Backend avec SpringDoc
  ],
)
...
#cv-entry(
  ...
  [
    - Backend Express.js et Prisma (Postgres) - Frontend Next.js et Tailwind
    - Déploiement Google Cloud avec Docker, Cloud SQL et Firestore
